...
import 'package:task1/features/Login/presentation/views/login_view.dart';
...
class RegisterViewDetails extends StatefulWidget {
  const RegisterViewDetails({
    super.key,
  });

  @override
  State<RegisterViewDetails> createState() => _RegisterViewDetailsState();
}

class _RegisterViewDetailsState extends State<RegisterViewDetails> {
  ...
  void populateSavedCredentials() async {
    ...
    if (savedUsername != null && savedPassword != null && savedEmail != null) {
      setState(() {
                  ...
                  child: CustomButton(
                    onTap: () {
                      if (formkey.currentState!.validate()) {
                        ...
                        if (rememberMe) {
                          CacheHelper
                              .saveCredentialsOfRegisterToSharedPreferences(
                                  userController.text,
                                  passController.text,
